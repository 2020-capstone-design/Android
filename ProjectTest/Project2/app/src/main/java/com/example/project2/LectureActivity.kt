...
import kotlinx.android.synthetic.main.activity_leacture.*
...
class LectureActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_leacture)

        // list_viewpager와 연결

        val fragmentAdapter = CategoryAdapter(supportFragmentManager)
        list_view.adapter = fragmentAdapter
        ...
        list_view.addOnPageChangeListener(listener)
        ...
        tab_layout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
            ...
            override fun onTabSelected(p0: TabLayout.Tab?) {
                println("-============================================2")
                if (p0 != null) {
                    list_view.currentItem = p0.position
                }
            }
