...
class SnackBar : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.activity_snack_bar, container, false)

        recyclerView = view.findViewById(R.id.listview_snackbar) as RecyclerView
        recyclerView.layoutManager = LinearLayoutManager(requireContext())

        load(view)

//        view.listview_snackbar.setOnItemClickListener { adapter, view, position, id ->
